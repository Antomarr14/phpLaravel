...
Route::group(['prefix' => 'docentes_grupos' , 'middleware' => 'auth_docentes'], function () {
    ...
    Route::post('/store', [DocenteGrupoController::class, 'store'])->name('docentes_grupos.store'); // Cambiado a post para el store
    Route::get('/edit/{id}', [DocenteGrupoController::class, 'edit'])->name('docentes_grupos.edit');
    Route::post('/update/{id}', [DocenteGrupoController::class, 'update'])->name('docentes_grupos.update'); // Cambiado a post para el update
    Route::get('/delete/{id}', [DocenteGrupoController::class, 'delete'])->name('docentes_grupos.delete');
    Route::post('/destroy/{id}', [DocenteGrupoController::class, 'destroy'])->name('docentes_grupos.destroy'); // Cambiado a post para el destroy
});
